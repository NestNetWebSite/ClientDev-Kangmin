...
export default function ExamBoardModifyForm() {
    ...
    const handleFormSubmit = useCallback(
        (event: FormEvent<HTMLFormElement>) => {
            ...
            axios
                .post(`${process.env.BACKEND_URL}/exam-collection-post/modify`, formData, {
    ...
    return (
        <form onSubmit={handleFormSubmit}>
            <div>
                <div>
                    <label htmlFor={'subjectInput'}>과목명을 입력해주세요.</label>
                    <div>
                        <PiBooks />
                        <input
                            id={'subjectInput'}
                ...
                <div>
                    <label htmlFor={'professorInput'}>교수명을 입력해주세요.</label>
                    <div>
                ...
                <div>
                    <label htmlFor={'yearInput'}>연도를 입력해주세요.</label>
                    <div>
                        <LiaCalendarAlt />
                        <input
                            id={'yearInput'}
                    ...
                    <div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                            />
                            <label htmlFor={'1stSemesterRadioButton'}>1학기</label>
                            <input
                                ...
                                onChange={handleInputChange}
                            />
                            <label htmlFor={'2ndSemesterRadioButton'}>2학기</label>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                            />
                            <label htmlFor={'midtermRadioButton'}>중간고사</label>
                            <input
                                id={'finalRadioButton'}
                                type={'radio'}
                                name={'examTypeCheckRadioButton'}
                                ...
                                onChange={handleInputChange}
                            />
                            <label htmlFor={'finalRadioButton'}>기말고사</label>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                <div>
                    <label htmlFor={'titleInput'}>게시글 제목을 입력해주세요.</label>
                    <div>
                        <MdTitle />
                        <input
                            id={'titleInput'}
