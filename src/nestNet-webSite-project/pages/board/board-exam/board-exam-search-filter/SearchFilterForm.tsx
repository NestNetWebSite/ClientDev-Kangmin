...
import useExamSearchFilterStore from '../../../../store/useExamSearchFilterStore';
import { useCallback } from 'react';
import { LiaChalkboardTeacherSolid } from 'react-icons/lia';
import { PiBooks, PiListNumbers } from 'react-icons/pi';
    ...
    return (
        <form className={'w-full'} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className={'w-1/2'}>
                        ...
                        <div className={'mb-10 flex flex-col'}>
                            ...
                            <Controller
                                control={control}
                                name={'semester'}
                                defaultValue={examSearchFilter.semester}
                                render={({ field }) => {
                                    return (
                                        <Select
                    ...
                    <div className={'w-1/2'}>
                        <div className={'mb-6 flex flex-col'}>
                            ...
                            <Controller
                                control={control}
                                name={'examType'}
                                defaultValue={examSearchFilter.examType}
                                render={({ field }) => {
                                    return (
                                        <Select
            ...
            <div className='my-2 flex items-center justify-between'>
                ...
                <button
                    type={'submit'}
                    className='rounded-2xl bg-rose-800 px-6 py-2 font-semibold text-white shadow-md duration-300 hover:scale-105'
                >
                    필터 적용
                </button>
            </div>
